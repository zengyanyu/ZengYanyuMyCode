...
public class DateUtil {
	...
	public static String getCurrentDate() {
		return DateFormatConstant.DATE_FORMAT.format(getCurrDate());
	}
	...
	private static void test1() {
		...
		String beginDateStr = DateFormatConstant.DATE_FORMAT.format(beginDate);
		System.out.println("beginDateStr = " + beginDateStr);
		Date endDate = getEndDate(getCurrDate());
		String endDateStr = DateFormatConstant.DATE_FORMAT.format(endDate);
