 ...
 * @author ZengYanyu
 * @Description
 * @Date 2020年11月22日 下午8:20:21
 * @see com.hibernate.config.OrderInterpreter.java
 */
public class OrderInterpreter implements Interpreter<InterpreteContext, OrExpression> {
