...
public class WsdBeanUtils {

	private final static Log LOG = LogFactory.getLog(WsdBeanUtils.class);

	/**
	 * 工具类的构造器私有化
	 */
	private WsdBeanUtils() {
	}
	...
	public static void copyProperties(Object src, Object dest, boolean containSuper) {
		List<Field> fields = WsdClassUtils.getFields(src.getClass(), containSuper);
